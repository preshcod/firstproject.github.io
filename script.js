(function () {
    ...
    document.querySelectorAll('.nav-links-wrapper .nav-link').forEach((navOption) => {
    ...
    document.querySelectorAll('.nav-links-wrapper .nav-link ul li:last-child').forEach((lastOption) => {
